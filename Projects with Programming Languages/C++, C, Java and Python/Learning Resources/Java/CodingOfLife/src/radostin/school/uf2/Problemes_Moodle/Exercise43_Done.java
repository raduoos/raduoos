...
//        System.out.println(buscaParaula("ll la le li lo lu", "ll", 0));
    ...
    //Exercici 43
    public static int buscaParaula(String text, String paraula, int position){
        int valorRetornat;
        valorRetornat=inicialitzarVariables(text,paraula, position);
        if(valorRetornat!=-2){
